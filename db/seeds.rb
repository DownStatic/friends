...
CardLibrary.create(name: "Sean's Mighty Punch!", power: 5, effect_type: "Attack", image: "")
CardLibrary.create(name: "May's Insults", power: 8, effect_type: "Attack", image: "")
CardLibrary.create(name: "Ink Barrage", power: 6, effect_type: "Attack", image: "")
CardLibrary.create(name: "Dank Memes", power: 3, effect_type: "Attack", image: "")
CardLibrary.create(name: "Oh $H1T!!!", power: 10, effect_type: "Attack", image: "")
CardLibrary.create(name: "Beer Pong Barrage", power: 4, effect_type: "Attack", image: "")
CardLibrary.create(name: "Call in Support from Maria", power: 7, effect_type: "Attack", image: "")
CardLibrary.create(name: "Throw Wario", power: 2, effect_type: "Attack", image: "")
CardLibrary.create(name: "Confuse with Pokemon Trivia", power: 3, effect_type: "Attack", image: "")
CardLibrary.create(name: "Ignore Text Messages", power: 3, effect_type: "Attack", image: "")
CardLibrary.create(name: "Confuse with Basketball Trivia", power: 3, effect_type: "Attack", image: "")
CardLibrary.create(name: "Pursuade into Bad Investments", power: 4, effect_type: "Attack", image: "")
CardLibrary.create(name: "Perfect Dive Animation", power: 5, effect_type: "Attack", image: "")
CardLibrary.create(name: "Grateful Death", power: 5, effect_type: "Attack", image: "")
CardLibrary.create(name: "Call in the Army", power: 9, effect_type: "Attack", image: "")
puts "seeding heal card library"
CardLibrary.create(name: "Garbage Armor!", power: 3, effect_type: "Heal", image: "")
CardLibrary.create(name: "Squirrel T-shirt Armor!", power: 3, effect_type: "Heal", image: "")
CardLibrary.create(name: "Restart Your Computer", power: 2, effect_type: "Heal", image: "")
CardLibrary.create(name: "Miriam's Soothing Voice", power: 3, effect_type: "Heal", image: "")
CardLibrary.create(name: "Take a Power Nap", power: 6, effect_type: "Heal", image: "")
CardLibrary.create(name: "Jordan Tells a Joke", power: 4, effect_type: "Heal", image: "")
CardLibrary.create(name: "Perfect Pour", power: 2, effect_type: "Heal", image: "")
CardLibrary.create(name: "Stream the Battle", power: 4, effect_type: "Heal", image: "")
CardLibrary.create(name: "Eat Jin Ai's Treats", power: 5, effect_type: "Heal", image: "")
